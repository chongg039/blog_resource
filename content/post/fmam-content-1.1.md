...
![Fig.1.1](https://farm2.staticflickr.com/1820/43795309612_219af12fec_z.jpg)
...
![Fig.1.2](https://farm1.staticflickr.com/930/29973814068_6365c5e4ae_z.jpg)
...
![Fig.1.3](https://farm2.staticflickr.com/1820/42035235420_fec620289e_z.jpg)
...
$$
f ^ {*} (s) \equiv E[e ^ {-sX}] \equiv \int _ {0} ^ {\infty} e ^ {-st} dP\\{X < t\\} = \int _ {0} ^ {\infty} e ^ {-st} \lambda e ^ {- \lambda t} dt = \lambda \int _ {0} ^ {\infty} e ^ {-(\lambda + s)t} dt = \frac{\lambda}{\lambda + s}
$$
